...
var _this=this;this.responsiveStatus=new _responsiveStatus2.default();this.subunit=subunit;//Apply book colors with class
...
$('.slider-indicators li[data-go-to="0"]').trigger('click');this.onSliderIndicatorClick(document.querySelector('.slider-indicators li[data-go-to="0"]'));}},{key:'goBlinkSlideWithSection',value:function goBlinkSlideWithSection(section){_.forEach(this.subunit.sections,function(sectionObj){if(sectionObj.hasOwnProperty('seccion')&&sectionObj.seccion==section){// document.querySelector(`.navbar-bottom ol.slider-indicators li.slider-indicator[data-sm-slide-id="${sectionObj.ID}"]`).click();
